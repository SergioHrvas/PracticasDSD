...
suma_matrices_1_svc(matrices arg1, struct svc_req *rqstp)
{
	...
	mu.v2_c = arg1.v2_c;
	mu.v2_f = arg1.v2_f;
	result_3 = suma_matrices_ult_1(mu, clnt);
...
resta_matrices_1_svc(matrices arg1, struct svc_req *rqstp)
{
	...
	mu.v2_c = arg1.v2_c;
	mu.v2_f = arg1.v2_f;
	result_3 = resta_matrices_ult_1(mu, clnt);
...
multi_matriz_escalar_1_svc(matrizyescalar arg1, struct svc_req *rqstp)
{
	...
	result_3 = multi_matriz_escalar_ult_1(mu, clnt);
...
divi_matriz_escalar_1_svc(matrizyescalar arg1, struct svc_req *rqstp)
{
	...
	result_3 = divi_matriz_escalar_ult_1(mu, clnt);
...
suma_fracciones_1_svc(fracciones arg1, struct svc_req *rqstp)
{
	...
	int mcd = maximo_comun_divisor(result.tipo_fraccion_u.f.num, result.tipo_fraccion_u.f.den);
	result.tipo_fraccion_u.f.num = result.tipo_fraccion_u.f.num / mcd;
	result.tipo_fraccion_u.f.den = result.tipo_fraccion_u.f.den / mcd;
...
tipo_fraccion *
simplificar_fraccion_1_svc(fraccion arg1, struct svc_req *rqstp)
{
	static tipo_fraccion result;

	int mcd = maximo_comun_divisor(arg1.num, arg1.den);
	result.tipo_fraccion_u.f.num = arg1.num / mcd;
	result.tipo_fraccion_u.f.den = arg1.den / mcd;
